...
(function () {
  ...
  var DATA = {
    ...
    "salons-current": [
      ...
      "WindowsFileDialogs.PickFilesAsync (CSV, Downloads, single)",
      "Copy selected file -> gData.ImportDirectory",
      "Filename must contain salon short name",
    ...
    "images-process": [
      ...
      "ImagesProcessAsync()",
      "Admin.FileUpload() -> WindowsFileDialogs.PickFilesAsync (*.zip, Downloads, multi)",
      "Copy selected zips -> gData.ImportDirectory (PhotoVault names)",
      "PhotosLocalUnzipAsync -> extract *.zip -> photosLocal\\{yyyy-MM}\\",
    ...
    "import-club": [
      ...
      "WindowsFileDialogs.PickFilesAsync (CSV, Downloads, single)",
      "Copy selected file -> gData.ImportDirectory",
      "Scoresheet* -> ImportScores / Results* -> ImportResults",
